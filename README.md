...
㉔ `RULE-SET,cnip` 来源于 [DustinWin/clash-geoip](https://github.com/DustinWin/clash-geoip)，源采用 [17mon/china_ip_list](https://github.com/17mon/china_ip_list)、[gaoyifan/china-operator-ip](https://github.com/gaoyifan/china-operator-ip) 和[亚太互联网络信息中心（APNIC）](http://ftp.apnic.net)组合
## 2. user.yaml  
